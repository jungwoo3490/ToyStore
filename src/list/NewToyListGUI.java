...
public class NewToyListGUI extends JPanel {
	...
	public void reset(GUIMain win) {
		this.win = win;
		win.jpanel05.removeAll();
		win.jpanel05.repaint();
		remove(win.jpanel05.itemTable);
		remove(win.jpanel05.btn);
